...
function HidingObjects()
{
	...
	this.objects[7] = new SingleObject({x: 3895, y: 385}, 3);
	this.objects[8] = new SingleObject({x: 3955, y: 385}, 3);
	this.objects[9] = new SingleObject({x: 4305, y: 610}, 3);
	this.objects[10] = new SingleObject({x: 4750, y: 665}, 3);
	this.objects[11] = new SingleObject({x: 5050, y: 610}, 3);
	this.objects[12] = new SingleObject({x: 5220, y: 610}, 3);
	this.objects[13] = new SingleObject({x: 5390, y: 610}, 3);
	this.objects[14] = new SingleObject({x: 5782, y: 331}, 3);
	this.objects[15] = new SingleObject({x: 6300, y: 610}, 3);
	this.objects[16] = new SingleObject({x: 6330, y: 548}, 3);
	this.objects[17] = new SingleObject({x: 6360, y: 610}, 3);
	this.objects[18] = new SingleObject({x: 6800, y: 555}, 3);
	this.objects[19] = new SingleObject({x: 6860, y: 555}, 3);
	this.objects[20] = new SingleObject({x: 6920, y: 555}, 3);
	this.objects[21] = new SingleObject({x: 6980, y: 555}, 3);
	this.objects[22] = new SingleObject({x: 6830, y: 493}, 3);
	this.objects[23] = new SingleObject({x: 6890, y: 493}, 3);
	this.objects[24] = new SingleObject({x: 6950, y: 493}, 3);
	this.objects[25] = new SingleObject({x: 6860, y: 431}, 3);
	this.objects[26] = new SingleObject({x: 6920, y: 431}, 3);
	this.objects[27] = new SingleObject({x: 7515, y: 555}, 3);
	this.objects[28] = new SingleObject({x: 8310, y: 554}, 3);
	this.objects[29] = new SingleObject({x: 8640, y: 554}, 3);
